...
/** 
 * DAO for table "SIMPLE_INDEXED_ENTITY".
*/
public class SimpleIndexedEntityDao extends AbstractDao<SimpleIndexedEntity, Long> {

    public static final String TABLENAME = "SIMPLE_INDEXED_ENTITY";

    /**
     * Properties of entity SimpleIndexedEntity.<br/>
    ...
    public SimpleIndexedEntityDao(DaoConfig config) {
        super(config);
    }
    
    public SimpleIndexedEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SIMPLE_INDEXED_ENTITY\" (" + //
        ...
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_SIMPLE_INDEXED_ENTITY_SIMPLE_INT ON SIMPLE_INDEXED_ENTITY" +
                " (\"SIMPLE_INT\" ASC);");
        db.execSQL("CREATE INDEX " + constraint + "IDX_SIMPLE_INDEXED_ENTITY_SIMPLE_STRING ON SIMPLE_INDEXED_ENTITY" +
                " (\"SIMPLE_STRING\" ASC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SIMPLE_INDEXED_ENTITY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SimpleIndexedEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SimpleIndexedEntity entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.get_id());
        stmt.bindLong(2, entity.getSimpleBoolean() ? 1L: 0L);
        stmt.bindLong(3, entity.getSimpleByte());
    ...
    @Override
    public SimpleIndexedEntity readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, SimpleIndexedEntity entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SimpleIndexedEntity entity, long rowId) {
        entity.set_id(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SimpleIndexedEntity entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(SimpleIndexedEntity entity) {
