...
public class ExtraBaseDao<T extends RealmObject> {

    protected ExtraRealmManager mManager;
    protected Realm mRealm;

    public ExtraBaseDao(Context context) {
        mManager = ExtraRealmManager.getInstance();
    ...
    public T queryById(long id, Class<T> object) {
        return mRealm.where(object).equalTo("_id", id).findFirst();
    }
